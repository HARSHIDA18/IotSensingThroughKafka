...
object KafkaProducerWithApi extends App{
  ...
  consumer.subscribe(Collections.singletonList("IotShaily"))
  val filePath = "G:\\HARSHIDAIot1\\src\\main\\scala\\sample_data.txt"
  ...
  scheduler.scheduleAtFixedRate(new Runnable {
    def run(): Unit={
      try {
        ...
        val record = new ProducerRecord[String, String]("IotShaily", processedMessage)
